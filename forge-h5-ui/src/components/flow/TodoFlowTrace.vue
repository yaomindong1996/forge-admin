...
.timeline-item:not(:last-child)::before, .process-node:not(:last-child)::after { position: absolute; top: 20rpx; bottom: 0; left: 8rpx; width: 2rpx; background: #e5e6eb; content: ''; }
...
.timeline-title, .process-node__copy text:first-child { color: var(--text-strong); font-size: 24rpx; font-weight: 500; }
...
.process-node__mark { position: relative; z-index: 1; width: 18rpx; height: 18rpx; margin-top: 6rpx; border: 4rpx solid #c9cdd4; border-radius: 50%; background: #fff; box-sizing: border-box; }
