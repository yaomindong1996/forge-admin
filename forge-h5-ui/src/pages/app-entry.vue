...
.app-entry { display: flex; min-height: 460rpx; flex-direction: column; align-items: center; justify-content: center; padding: 36rpx 28rpx; border: 1rpx solid var(--border-color); border-radius: var(--radius-card); text-align: center; background: #fff; box-sizing: border-box; }
.app-entry__icon { display: flex; width: 72rpx; height: 72rpx; align-items: center; justify-content: center; border: 1rpx solid #dbe7f7; border-radius: 8rpx; background: var(--primary-soft); }
.app-entry__title { display: block; margin-top: 20rpx; color: var(--text-strong); font-size: 29rpx; font-weight: 650; }
.app-entry__desc { display: block; max-width: 520rpx; margin: 10rpx 0 26rpx; color: var(--text-secondary); font-size: 22rpx; line-height: 1.6; }
</style>
