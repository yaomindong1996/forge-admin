...
import { ChartModeEnum } from '@/store/modules/chartLayoutStore/chartLayoutStore'
...
import { ConfigType, CreateComponentType, PackagesCategoryEnum } from '@/packages'
import { ChatCategoryEnum } from '@/packages/components/Photos'
