...
public class WebFluxStreamableClientTransportBuilder {

    public static WebClientStreamableHttpTransport build(WebClient.Builder webClientBuilder, McpJsonMapper jsonMapper,
                                                         String sseEndpoint) {
