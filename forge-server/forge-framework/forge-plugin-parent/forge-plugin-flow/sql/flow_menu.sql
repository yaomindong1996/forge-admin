...
VALUES 
(0, '待办任务查询', @flow_todo_id, 4, 10, 'flow:task:todo', 'GET', '/api/flow/task/todo', 0, 0, 1, 1, '查询待办任务', NOW(), NOW()),
(0, '已办任务查询', @flow_done_id, 4, 11, 'flow:task:done', 'GET', '/api/flow/task/done', 0, 0, 1, 1, '查询已办任务', NOW(), NOW()),
(0, '发起的流程查询', @flow_started_id, 4, 12, 'flow:task:started', 'GET', '/api/flow/task/started', 0, 0, 1, 1, '查询发起的流程', NOW(), NOW()),
